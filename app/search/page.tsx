    ...
    <div className="min-h-screen bg-[var(--bg)]">
      <main className="mx-auto max-w-screen-xl px-3 py-4 sm:px-4">
        ...
        <div className="mb-6 space-y-4">
          <div>
            <h1 className="font-mono text-[22px] font-bold tracking-tight text-[var(--text)]">Search</h1>
            <p className="mt-1 font-mono text-[10px] text-[var(--text-muted)]">Find stocks, crypto, forex, commodities, and ETFs</p>
          </div>
        </div>
